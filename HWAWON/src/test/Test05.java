...
public class Test05 {
	...
	static CartItem02[] mCartItem02 = new CartItem02[book_Num];
...
//		System.out.println("이름 " + perObj.getName() + "연락처 " + perObj.getPhone());
	...
	public static void menuCartItem02List() {
//		System.out.println("장바구니 상품 목록 :");
//		System.out.println("-------------------------------------------");
//		System.out.println("  도서ID\t|     수량\t|     합계");
//
//		for (int i = 0; i < mCartCount; i++) { // 장바구니에 담긴 상품 수만큼 반복
//			System.out.print(mCartItem02[i].getBookID() + "|");
//			System.out.print("      " + mCartItem02[i].getQuantity() + "\t| ");
//			System.out.print("   " + mCartItem02[i].getTotalPrice());
//			System.out.println("   ");
//		}
//		System.out.println("-------------------------------------------");
	}
			...
			if (flag) {
				...
				if (input.toUpperCase().equals("Y")) {
					...
					if (!isCartInbook(book[numId][0]))
						mCartItem02[mCartCount++] = new CartItem02(book[numId]);
					quit = true;
					menuCartItem02List();
				}
			} else
	...
	public static boolean isCartInbook(String bookId) {
		...
		for (int i = 0; i < mCartCount; i++) {
			if (bookId == mCartItem02[i].getBookID()) {
				mCartItem02[i].setQuantity(mCartItem02[i].getQuantity() + 1);
			}
		}
		return flag;
	}
